...
"use strict";$(document).ready(function(){$(".parallax__list").parallax()}),$(document).ready(function(){$("ul.parallax__list>li").addClass("layer")}),$(document).ready(function(){$(".wrapper").addClass("active")});
